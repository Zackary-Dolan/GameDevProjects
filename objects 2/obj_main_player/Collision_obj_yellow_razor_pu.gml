...
has_yellow_razor = true;

instance_destroy(other);
instance_create_depth(0, 0, 0, obj_yellow_razor_display_controller);
instance_create_depth(x, y, 0, obj_assess_yellow_razor1);
instance_create_depth(x, y, 0 ,obj_assess_yellow_razor2);
instance_create_depth(x, y, 0, obj_assess_yellow_razor3);
instance_create_depth(x, y, 0 ,obj_assess_yellow_razor4);